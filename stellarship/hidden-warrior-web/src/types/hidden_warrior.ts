 ...
 * IDL can be found at `target/idl/hidden_warrior.json`.
 */
export type HiddenWarrior = {
  "address": "FKGxSs58T1noCiGXdVRYPYESeuLvsXwFwfyjqQ8Sxn1o",
  "metadata": {
    "name": "hiddenWarrior",
    "version": "0.1.0",
    "spec": "0.1.0",
    "description": "Confidential Hidden Warrior Game with Arcium & Anchor"
  },
  "instructions": [
    {
      "name": "battleWarrior",
