...
export const MedievalButton: React.FC<MedievalButtonProps> = ({
    ...
    const baseStyles = "relative group font-medieval uppercase tracking-wider transition-all duration-200 ease-out active:translate-y-[2px] active:shadow-none select-none overflow-hidden isolate";
