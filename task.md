...
The game studio is an optional starting point to get you building as quickly as possible, it is not a requirement to use it for the hackathon. However interaction with the game hub mock contract to call start_game() and end_game() is a requirement and there are examples in the studio and an interface here: https://stellar.expert/explorer/testnet/contract/CB4VZAT2U3UC6XFK3N23SKRF2NDCMP3QHJYMCHHFMZO7MRQO6DQ2EMYG?filter=interface
